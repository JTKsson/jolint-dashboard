        ...
        <div>
          ...
          <p>
            {percentageChange > 0
              ...
              : `-${Math.abs(percentageChange).toFixed(2)}%`} since last month
          </p>
        </div>
        <div>
          <Image src="/images/positive-arrow-green-icon.svg" alt="Green arrow icon" width={20} height={20} className={styles.arrow} />
          <p>above benchmark</p>
        </div>
      </div>
